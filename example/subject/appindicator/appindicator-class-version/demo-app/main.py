...
class App:
	...
	def init_menu(self):
		...
		item.connect('activate', self.on_activate_app)
		menu.append(item)
	...
	def init_win(self):
		...
		win.connect("delete-event", self.on_deactivate_app)
	...
	def on_deactivate_app(self, win, evt):
		print('')
		print('on_deactivate_app:')
		print('	win:', win)
		print('	evt:', evt)
		self.do_hide_app()
		self.do_switch_on_deactivate_icon()
		return True ## must
