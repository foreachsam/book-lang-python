...
class Dia:
	...
	title = 'Question:'
	message = 'Quit application. Are you sure?'

	def __init__ (self):
		pass

	def init (self):
		self.dia = dia = Gtk.MessageDialog(
			self.win,
			0,
		...
		dia.format_secondary_text(self.message)
...
## https://lazka.github.io/pgi-docs/index.html#Gtk-3.0/classes/MessageDialog.html
